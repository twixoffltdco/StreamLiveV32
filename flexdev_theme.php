...
$cssPath = __DIR__ . '/assets/themes/flexdev.css';
if (!file_exists($cssPath)) { die('assets/themes/flexdev.css не найден на диске'); }

$themes = themes_all();
$themes = array_values(array_filter($themes, fn($t) => ($t['slug'] ?? '') !== 'flexdev'));
$themes[] = ['slug' => 'flexdev', 'name' => 'FlexDev', 'css' => '/assets/themes/flexdev.css', 'header' => null, 'footer' => null];
