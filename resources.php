...
<div class="container">
  ...
  <div class="grid">
    <?php foreach ($items as $r): ?>
      <article class="card"><h3><a href="<?= e(resource_url($r)) ?>"><?= e($r['title']) ?></a></h3><p><?= e($r['summary']) ?></p><p style="color:var(--text-dim);font-size:12px">Автор: <?= e($r['username']) ?> · <?= e($r['created_at']) ?> · <?= e($r['tags']) ?></p></article>
    <?php endforeach; ?>
