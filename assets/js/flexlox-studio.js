(function () {
  var canvas = document.getElementById('flx-canvas');
  if (!canvas) return;
  ...
  empty();
  try {
    if (window.__FLX_INITIAL__) {
      var raw = typeof window.__FLX_INITIAL__ === 'string' ? JSON.parse(window.__FLX_INITIAL__) : window.__FLX_INITIAL__;
  ...
  var form = document.getElementById('flx-form');
  if (form) {
