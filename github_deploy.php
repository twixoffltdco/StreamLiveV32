...
// Единая функция используется и тут, и в отладке/админке, чтобы правило не разъезжалось.
deployed_services_ensure_schema();
$__activeServicesCount = deployed_service_active_count((int)$__user['id']);
$__maxServices = deployed_service_limit_for($__user);
