...
<div class="container">
  ...
  <div class="grid">
    <?php foreach ($items as $r): ?>
      <article class="card"><h3><a href="<?= e(resource_url($r)) ?>"><?= e($r['title']) ?></a></h3><p><?= e($r['summary']) ?></p><p style="color:var(--text-dim);font-size:12px"><span class="res-author" style="display:inline-flex;align-items:center;gap:6px;flex-wrap:wrap"><?php
        $au = [
        ...
        echo function_exists('render_user_badge') ? render_user_badge($au, 20) : e($r['username']);
      ?></span>
      <span style="color:var(--text-dim);font-size:12px"> · <?= e($r['created_at']) ?><?php if (!empty($r['tags'])): ?> · <?= e($r['tags']) ?><?php endif; ?></span></p></article>
    <?php endforeach; ?>
